...
#define TICK_SCALE_TO_MS    2   /* Fallback for time multiplier */
 ...
 * @return None
 */
void platform_set_vconn(void* dev, FSC_BOOL enable);
 ...
 */
FSC_BOOL platform_i2c_write(void* dev,
 ...
 * @return TRUE - success, FALSE otherwise
 */
FSC_BOOL platform_i2c_read( void* dev,
                            FSC_U8 RegAddrLength,
                            FSC_U8 DataLength,
                            FSC_U8 PacketSize,
                            FSC_U8 IncSize,
